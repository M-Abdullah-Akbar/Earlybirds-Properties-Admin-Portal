...
function AdminLoginContent() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "username") {
      if (!trimmedValue) {
        ...
        fieldError = "Username cannot exceed 50 characters";
      ...
      if (!trimmedValue) {
        ...
        fieldError = "Password cannot exceed 128 characters";
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    // Client-side validation - show only the first error in field order
    let firstError = {};
    if (!cleanCredentials.username) {
      firstError.username = "Username is required";
    } else if (!cleanCredentials.password) {
      firstError.password = "Password is required";
    }

    // If there are validation errors, show only the first one and stop
