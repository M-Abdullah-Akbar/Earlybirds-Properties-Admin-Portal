    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot insert row above: cursor is not in a table cell");
        }
      },
      ...
      icon: "ArrowUp",
      condition: (commands) => {
        // Only show if we're in a table context
        try {
          return commands.editor && commands.editor.getEditorState().read(() => {
            const selection = commands.editor.getEditorState()._selection;
            return selection && selection.anchor && selection.anchor.getNode && 
                   selection.anchor.getNode().getTopLevelElementOrThrow().getType() === 'table';
          });
        } catch {
          return false;
        }
    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot insert row below: cursor is not in a table cell");
        }
      },
    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot insert column left: cursor is not in a table cell");
        }
      },
    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot insert column right: cursor is not in a table cell");
        }
      },
    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot delete row: cursor is not in a table cell");
        }
      },
    ...
    },
    {
      ...
      action: (commands) => {
        try {
          ...
          console.warn("Cannot delete column: cursor is not in a table cell");
        }
      },
