            ...
            <form className="form-account" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="box">
                ...
                <fieldset className="box-fieldset">
                  ...
                  <div className="text-forgot text-end">
                    <a href="#" style={{ color: "#bd8c31" }}>Forgot password</a>
                  </div>
                </fieldset>
              </div>
              <div className="box box-btn">
                <Link
                  ...
                  style={{ backgroundColor: "#bd8c31", borderColor: "#bd8c31" }}
                >
                  Login
                </Link>
              ...
              <p className="box text-center caption-2" style={{ color: "#bd8c31" }}>or login with</p>
              <div className="group-btn">
                <a href="#" className="btn-social" style={{ borderColor: "#bd8c31" }}>
                  <svg
                    width={21}
                    height={20}
                    viewBox="0 0 21 20"
