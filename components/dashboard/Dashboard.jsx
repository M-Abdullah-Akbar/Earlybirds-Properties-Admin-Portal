      ...
      <div className="main-content-inner wrap-dashboard-content">
        ...
        <div className="widget-box-2 wd-listing mb-20">
          <div className="welcome-section">
            <h2 className="welcome-title">Welcome to EarlyBirds Properties Admin Dashboard</h2>
            <p className="welcome-subtitle">Manage your properties and users efficiently</p>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-3">
              <div className="stat-card">
                ...
                <div className="stat-content">
                  <h3 className="stat-number">{stats.activeProperties}</h3>
        ...
        <div className="widget-box-2 wd-listing mb-20">
          <div className="d-flex justify-content-between align-items-center mb-20">
            ...
            <Link href="/admin/property-management" className="tf-btn bg-color-primary pd-13">
              View All Properties
            </Link>
          </div>
          ...
          {recentProperties.length === 0 ? (
            <div className="text-center py-30">
              ...
              <Link href="/admin/add-property" className="tf-btn bg-color-primary pd-13 mt-20">
                ...
                <div key={property._id || property.id} className="property-card">
                  <div className="property-image">
                    <Image
                      ...
                      className="img-fluid"
                    />
                    <div className={`status-badge ${getStatusClass(property.status)}`}>
                  ...
                  <div className="property-content">
                    ...
                    <p className="property-location">
                      ...
                      {property.location?.address || property.location || "Location not specified"}
                    </p>
                    ...
                    <div className="property-details">
                      ...
                      <div className="detail-item">
                        ...
                        <span className="value">{property.propertyType || property.listingType || "N/A"}</span>
                      </div>
                      <div className="detail-item">
                        <span className="label">Bedrooms:</span>
                        <span className="value">{property.details?.bedrooms || property.bedrooms || property.beds || "N/A"}</span>
                      </div>
                      <div className="detail-item">
                        <span className="label">Area:</span>
                        <span className="value">
                          {property.details?.area || property.area || property.sqft || "N/A"} 
                    ...
                    <div className="property-actions">
                      <Link
                        href={`/admin/edit-property/${property._id || property.id}`}
        ...
        <div className="widget-box-2 wd-listing mb-20">
          <div className="d-flex justify-content-between align-items-center mb-20">
            ...
            <Link href="/admin/user-management" className="tf-btn bg-color-primary pd-13">
              View All Users
            </Link>
          </div>
                ...
                <div key={user._id || user.id} className="user-card">
                  ...
                  <div className="user-content">
                    ...
                    <div className="user-actions">
                      <Link
                        href={`/admin/edit-user/${user._id || user.id}`}
                        className="tf-btn bg-color-primary pd-10"
                      >
                        Edit
                      </Link>
        ...
        <div className="widget-box-2 wd-listing">
          ...
          <div className="quick-actions-grid">
            ...
            <Link href="/admin/property-management" className="quick-action-card">
              <div className="action-icon">
                <i className="icon icon-home"></i>
              </div>
